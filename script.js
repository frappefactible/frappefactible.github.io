document.addEventListener('DOMContentLoaded', () => {
    ...
    const mediaList = [
        ...
        { id: 52, title: '[バッカーノ!] Baccano! (2007)', type: 'Anime', phase: 7, phaseName: 'TELARAÑA NARRATIVA', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/qOxUTQAOTrMKTHuC9HQZiVsTK0F.jpg' },
        { id: 53, title: '[Fight Club] El Club de la Pelea (1999)', type: 'Película', phase: 7, phaseName: 'TELARAÑA NARRATIVA', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/sgTAWJFaB2kBvdQxRGabYFiQqEK.jpg' },
        { id: 54, title: '[올드보이] Oldboy (2003)', type: 'Película', phase: 7, phaseName: 'TELARAÑA NARRATIVA', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/45kRW1xgTq3QrZltL9mY9e9iYkH.jpg' },
        { id: 55, title: '[Like a Dragon: Yakuza] Like a Dragon: Yakuza (2024)', type: 'Serie', phase: 7, phaseName: 'TELARAÑA NARRATIVA', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/4uFt0lyo2UrMkTKCXH2VgxWz2jE.jpg' },
        { id: 56, title: '[Next] El Vidente (2007)', type: 'Película', phase: 7, phaseName: 'TELARAÑA NARRATIVA', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/yNeoZYQ93Mkl6NxdEGuoBKJz1G8.jpg' },
        { id: 57, title: '[DARKER THAN BLACK -黒の契約者-] Darker than Black (2007)', type: 'Anime', phase: 7, phaseName: 'TELARAÑA NARRATIVA', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/i2jS5N0FK9o58Lxh5mnkOzEDZsd.jpg' },
        { id: 58, title: '[LAZARUS ラザロ] Lazarus (2025)', type: 'Anime', phase: 7, phaseName: 'TELARAÑA NARRATIVA', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/ActpqKbShWGYNDRsCjTueRixlrr.jpg' },
        // Fase 8: AVENTURA Y ADRENALINA
        { id: 59, title: '[紅の豚] Porco Rosso (1992)', type: 'Película Anime', phase: 8, phaseName: 'AVENTURA Y ADRENALINA', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/j3RaEwYQ2D4fbdr3nMa3JXSK15o.jpg' },
        { id: 60, title: '[Whiplash] Whiplash (2014)', type: 'Película', phase: 8, phaseName: 'AVENTURA Y ADRENALINA', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/sL32IZkyjlF7otj5vcUxiKSKzg5.jpg' },
        { id: 61, title: '[Nobody] Nadie (2021)', type: 'Película', phase: 8, phaseName: 'AVENTURA Y ADRENALINA', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/ddO5a3tMPpQutSDQO1bESgLWadB.jpg' },
        { id: 62, title: '[Atomic Blonde] Atómica (2017)', type: 'Película', phase: 8, phaseName: 'AVENTURA Y ADRENALINA', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/9DRFozlq1IMD7aMLzdRzWEEH6SH.jpg' },
        { id: 63, title: '[The Raid: Redemption] The Raid (2011)', type: 'Película', phase: 8, phaseName: 'AVENTURA Y ADRENALINA', imageUrl: 'https://image.tmdb.org/t/p/original/Abnm1Ws3JH0ReCfEhLMPwPcMcGO.jpg' },
        // Fase 9: ABISMO REFLEXIVO
        { id: 64, title: '[GHOST IN THE SHELL / 攻殻機動隊] Ghost in the Shell (1995)', type: 'Película Anime', phase: 9, phaseName: 'ABISMO REFLEXIVO', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/mo4PUj0SWiX33uQMgxyzE2ZOPBK.jpg' },
        { id: 65, title: '[イノセンス] Ghost in the Shell 2: Innocence (2004)', type: 'Película Anime', phase: 9, phaseName: 'ABISMO REFLEXIVO', imageUrl: 'https://image.tmdb.org/t/p/original/w2JxX0zCHtTU7XrNjHBij2uZKiV.jpg' },
        { id: 66, title: '[The Animatrix] Animatrix (2003)', type: 'Película Anime', phase: 9, phaseName: 'ABISMO REFLEXIVO', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/g52SOsTvdjzY8oPIn5znLJMzLHG.jpg' },
        { id: 67, title: '[The Matrix] Matrix (1999)', type: 'Película', phase: 9, phaseName: 'ABISMO REFLEXIVO', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/5cDHSeoVVZqypEkphJQ0a4FHRjF.jpg' },
        { id: 68, title: '[Gattaca] Gattaca (1997)', type: 'Película', phase: 9, phaseName: 'ABISMO REFLEXIVO', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/1gXcEISnpV8IXCylhGI4eyBKjM.jpg' },
        { id: 69, title: '[Equilibrium] Equilibrium (2002)', type: 'Película', phase: 9, phaseName: 'ABISMO REFLEXIVO', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/eW3YrxOh3rd6PnRgMSftYoflvfe.jpg' },
        { id: 70, title: '[エルゴプラクシー] Ergo Proxy (2006)', type: 'Anime', phase: 9, phaseName: 'ABISMO REFLEXIVO', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/tHcce6PKnhNBneSMbadI4jynHpY.jpg' },
        { id: 71, title: '[虐殺器官] Genocidal Organ (2017)', type: 'Película Anime', phase: 9, phaseName: 'ABISMO REFLEXIVO', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/aL5mNV5UgUoQ00qsC6dvwgQcIbA.jpg' },
        { id: 72, title: '[The Man in the High Castle] The Man in the High Castle (2015)', type: 'Serie', phase: 9, phaseName: 'ABISMO REFLEXIVO', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/4IljeGfUK3QpYxDUJKyi7K411Ro.jpg' },
        { id: 73, title: '[NieR:Automata Ver1.1a] NieR:Automata Ver1.1a (2023)', type: 'Anime', phase: 9, phaseName: 'ABISMO REFLEXIVO', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/qHSCYOXHV3EKXKkMxUvC9rGx4Av.jpg' },
        // Fase 10: ESPÍRITU, COMEDIA Y ROMANCE
        { id: 74, title: '[はじめの一歩] Hajime no Ippo: The Fighting! (2000)', type: 'Anime', phase: 10, phaseName: 'ESPÍRITU, COMEDIA Y ROMANCE', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/1LApB9C9kEkh2ZU2vzAhurNDipl.jpg' },
        { id: 75, title: '[ゴールデンボーイ] Golden Boy (1995)', type: 'Anime', phase: 10, phaseName: 'ESPÍRITU, COMEDIA Y ROMANCE', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/ahkQ6qnqouwZw7nro2YDEYLzrNn.jpg' },
        { id: 76, title: '[時々ボソッとロシア語でデレる隣のアーリャさん] Alya Sometimes Hides Her Feelings in Russian (2024)', type: 'Anime', phase: 10, phaseName: 'ESPÍRITU, COMEDIA Y ROMANCE', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/hfnzByZIRj6rx8xaxzS2zDilei1.jpg' },
        { id: 77, title: '[エクセル・サーガ] Excel Saga (1999)', type: 'OVA', phase: 10, phaseName: 'ESPÍRITU, COMEDIA Y ROMANCE', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/sr5nHUOuGDmysbANKJN1eV2wzrX.jpg' },
        { id: 78, title: '[トモちゃんは女の子!] Tomo-chan Is a Girl! (2023)', type: 'Anime', phase: 10, phaseName: 'ESPÍRITU, COMEDIA Y ROMANCE', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/h9TN2BltJ9Q7FZ5BYGQcHfYfEGp.jpg' },
        { id: 79, title: '[天幕のジャードゥーガル] A Witch\'s Life in Mongol (2021)', type: 'Manga', phase: 10, phaseName: 'ESPÍRITU, COMEDIA Y ROMANCE', imageUrl: 'https://upload.wikimedia.org/wikipedia/en/b/b4/A_Witch%27s_Life_in_Mongol_volume_1_cover.jpg' },
        // Fase 11: CUMBRE EXPERIMENTAL
        { id: 80, title: '[パプリカ] Paprika (2006)', type: 'Película Anime', phase: 11, phaseName: 'CUMBRE EXPERIMENTAL', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/j9QZkFkaR9LmvRumn88te0d6qsC.jpg' },
        { id: 81, title: '[PERFECT BLUE] Perfect Blue (1998)', type: 'Película Anime', phase: 11, phaseName: 'CUMBRE EXPERIMENTAL', imageUrl: 'https://image.tmdb.org/t/p/original/79vujbsWEbX4dzffBV541QXN6sf.jpg' },
        { id: 82, title: '[TENET] TENET (2020)', type: 'Película', phase: 11, phaseName: 'CUMBRE EXPERIMENTAL', imageUrl: 'https://image.tmdb.org/t/p/original/67p7XVP5SLup521iD9cAayMNt2U.jpg' },
        { id: 83, title: '[Blade Runner 2049] Blade Runner 2049 (2017)', type: 'Película', phase: 11, phaseName: 'CUMBRE EXPERIMENTAL', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/cOt8SQwrxpoTv9Bc3kyce3etkZX.jpg' },
        // Fase 12: Cazadores de Demonios. Sangre. Caos.
        { id: 84, title: '[無限の住人] Blade of the Immortal (2008)', type: 'Anime', phase: 12, phaseName: 'Cazadores de Demonios. Sangre. Caos.', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/ufo6y5FUdhUOXc97zZhpvmcQLRP.jpg' },
        { id: 85, title: '[無限の住人-IMMORTAL-] Mugen no Juunin: Immortal (2019)', type: 'Anime', phase: 12, phaseName: 'Cazadores de Demonios. Sangre. Caos.', imageUrl: 'https://image.tmdb.org/t/p/original/dx8PMM2cQSe4dmzLtj1sBkAIYHw.jpg' },
        { id: 86, title: '[鬼武者] Onimusha (2023)', type: 'Anime', phase: 12, phaseName: 'Cazadores de Demonios. Sangre. Caos.', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/lfRmDHegR8OpU3859lBz9YHgD79.jpg' },
        { id: 87, title: '[クレイモア] Claymore (2007) ', type: 'Anime', phase: 12, phaseName: 'Cazadores de Demonios. Sangre. Caos.', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/rQt8X4kjBxah0laGwUVJISf1086.jpg' },
        { id: 88, title: '[Devil May Cry] Devil May Cry (2025)', type: 'Anime', phase: 12, phaseName: 'Cazadores de Demonios. Sangre. Caos.', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/mX9tqfpjqwreONJHhap7SnSSowe.jpg' },
        { id: 89, title: '[チェンソーマン レゼ篇] Chainsaw Man - The Movie: Reze Arc (2025)', type: 'Película Anime', phase: 12, phaseName: 'Cazadores de Demonios. Sangre. Caos.', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/3gq3Nc6wkgXrjPTkebAwOwe8l7x.jpg' },
        { id: 90, title: '[ダンダダン] Dandadan (2024)', type: 'Anime', phase: 12, phaseName: 'Cazadores de Demonios. Sangre. Caos.', imageUrl: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/bOPmmOXj33bxVW5DoWabkCLn6vE.jpg' },
